...
::
    ...
    """
    document = MyRstDocument(text=text)

The rendering will output:

.. image:: images/MyRstDocument.png

Usage with Source
-----------------

You can also render a rst file using the :attr:`~MyRstDocument.source` property::

    document = MyRstDocument(source='index.rst')
...
class MyRstDocument(MDBoxLayout):
    ...
    background_color = AliasProperty(_get_bgc, _set_bgc,
                                     bind=('colors',),
                                     cache=True)
    '''Specifies the background_color to be used for the MyRstDocument.
    ...
    .. warning::
        ...
        :meth:`MyRstDocument.render` if you change them after loading.
    ...
    def __init__(self, **kwargs):
        ...
        super(MyRstDocument, self).__init__(**kwargs)
    ...
    def goto(self, ref, *largs):
        ...
        .. note::
            ...
            size of the MyRstDocument has not yet been determined. In
...
if __name__ == '__main__':
    ...
    import sys
    runTouchApp(MyRstDocument(source=sys.argv[1]))